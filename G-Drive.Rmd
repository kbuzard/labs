...
-   **Manufa_Emp_C000_2\_Buffers_2 (.cpg, .dbf, .shp, .shx)** -
...
-   **cal_lab_fields** -- A folder for 34 different indutries i.e. AERO --AERO (.cpg, .dbf, .prj, .shp, .shx)
...
-   **field_org --firm_struc** --

-   **GeoCode_OCR --GeoCoder** --
...
-   **5_mile_LDS** - Shows Originating Patents, Citing Patents, From Same Cluster, Percent (C/B), Treatment Patents, Treatment Citing For Same Cluster, Percent (F/E), Control Patents, Control Citing From Same Cluster, Percent (I/H), Location Differential (G/J), and P-values for 5-mile cluster in California. (excel)

-   **10_mile_LDS** - Shows Originating Patents, Citing Patents, From Same Cluster, Percent (C/B), Treatment Patents, Treatment Citing For Same Cluster, Percent (F/E), Control Patents, Control Citing From Same Cluster, Percent (I/H), Location Differential (G/J), and P-values for 10-mile cluster in California. (excel)

-   **Spatial_LDS** - Table that compares the 5 and 10 mile clusters (excel)

#### ZipData folder

first two folders are dublicate folders of the "nhgis0005_csv" and "tl_2010_us_zcta500" folders found below
...
-   **USA_ZCTA_emp(CPG, DBF, PRJ, SBN, SHX)** - Map of the US separated by ZCTA or zipcodes
...
-   **nhgis0005_ds151_2000_zcta** - excel files with 55 variables but only 32 variables have observations. Contains GISJOIN from the year 2000.
