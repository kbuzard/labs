...
PROC IMPORT OUT= WORK.&dat 
            DATAFILE= "H:\Jerry\Bob Hunt\Zip Codes\CA buffer shapes files\&dat..dbf" 
            DBMS=DBF REPLACE;
     GETDELETED=NO;
RUN;
...
data origcites (keep = cited patent o_pdpass o_appyear o_gday o_gmonth o_gyear);
retain cited citing o_pdpass o_appyear o_gday o_gmonth o_gyear;
...
data citations;
retain cited patent o_pdpass pdpass o_appyear o_gday o_gmonth o_gyear appyear gyear nclass;
