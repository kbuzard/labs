...
-   [**1979IRL16.pdf**](G:\MAX-Filer\Collab\Labs-kbuzard-S18\Admin\ramosRivera\DART_IRL%20Scans/1979IRL16) - copy of the 1979IRL16 pdf in DART_IRL Scans folder.

-   **1989_Digitized.txt** - digitized version of the 1989 DART pdf

-   [**1989DART23.pdf**](G:\MAX-Filer\Collab\Labs-kbuzard-S18\Admin\ramosRivera\1989DART23) - copy of the 1989DART23 pdf in DART_IRL Scans folder. R

-   **corr_cattLabs97_Wgeocode 1-6200.cvs** - excel file with lines 1-6200 corrected by Dylan. excel file with lines 1-6200 corrected by Dylan.

-   [**corr_cattLabs97_Wgeocode.cvs**](G:\MAX-Filer\Collab\Labs-kbuzard-S18\Admin\ramosRivera\T-Burk\pngData\corr_cattLabs97_Wgeocode) - original excel file before Dylan and Kelly worked on it.

-   **corr_cattLabs97_Wgeocode_Line 6200 to Line 12765.cvs** - excel file with lines 6200-12765 corrected by Kelly.

-   [**OCR_Result_NO_user.txt**](G:\MAX-Filer\Collab\Labs-kbuzard-S18\Admin\ramosRivera\T-Burk\pngData\OCR_Result_NO_user) - Antonio's intial OCR scan.
...
-   [**OneDrive_2021-08-27**](G:\MAX-Filer\Collab\Labs-kbuzard-S18\Admin\Summer2021_Kelly\Task%20From%20Antonio%201\Original%20Material) - zip drive that leads to the original material folder in Task From Antonio 1 folder.
...
-   [**letter_I\_cattell.txt**](G:\MAX-Filer\Collab\Labs-kbuzard-S18\Admin\ramosRivera\T-Burk\pngData\letter_I_cattell) - digitized version of the research labs starting with the letter "I."

-   [**letter_O\_cattell.txt**](G:\MAX-Filer\Collab\Labs-kbuzard-S18\Admin\ramosRivera\T-Burk\pngData\letter_O_cattell) - digitized version of the research labs starting with the letter "O."

-   [**letter_S\_cattell.txt**](G:\MAX-Filer\Collab\Labs-kbuzard-S18\Admin\ramosRivera\T-Burk\pngData\letter_S_cattell) - digitized version of the research labs starting with the letter "S."
...
-   [**1979_Digitized.pdf**](G:\MAX-Filer\Collab\Labs-kbuzard-S18\Admin\ramosRivera\Summer2021_Dylan\1979_Digitized.pdf) - digitized version of the 1979 IRL pdf. For original refer to

#### Task From Antonio 3 Folder

-   **1989_Digitized.txt** - digitized version of the 1989 DART pdf [Admin/ramosRivera/Summer2021_Dylan/1989_Digitized.pdf](G:\MAX-Filer\Collab\Labs-kbuzard-S18\Admin\ramosRivera\Summer2021_Dylan\1989_Digitized.pdf)
...
-   **USA_block** (.cpg, dbf, Adobe, .shx) - pngwork.py and input for shapeStich.py
...
-   **cattell-all** (STATA) - input file for pngwork
...
Moved from Census July 13, 2022 for OCR.py script. All files in this folder are tsv and txt files copied from [Ivan png website](https://drive.google.com/drive/folders/1JVsX1yhCptfCGsrSNeTNlpvdbO84eyQY). For further documentation refer to [File-list.docx](https://drive.google.com/drive/folders/1JVsX1yhCptfCGsrSNeTNlpvdbO84eyQY).

##### **OCR_Output_1998** Folder 

Input files for OCR.py

-   **letter_I\_cattell.csv** (excel) --
...
Created this folder July 13, 2022 for pdf2Jpg.py script. All files in here are the output of pdf2Jpg.py. They are images (jpg) of the pdfs in the Folder ScanData.

##### Scan Folder

Moved folder from the Census Folder on July 13, 2022 in order for the pdf2Jpg.py script to run. All files in this folder are pdfs scans copied from [Ivan png website](https://drive.google.com/drive/folders/1JVsX1yhCptfCGsrSNeTNlpvdbO84eyQY). For further documentation refer to [File-list.docx](https://drive.google.com/drive/folders/1JVsX1yhCptfCGsrSNeTNlpvdbO84eyQY).

#### Python Scripts Folder

-   **.pylint.d** - sub folder that contains only
