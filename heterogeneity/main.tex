...
The significance of the agglomeration of R\&D labs has been researched and reaffirmed on multiple occasions; %this is NOT the way to lead off. need a hook
...
{\color{red}(something needs to be fixed here because there's an extra blank page)} 
